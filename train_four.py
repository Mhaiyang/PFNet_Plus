...
ckpt_path = '/media/iccd/disk2/cos/cos_ckpt'
exp_name = 'V33_33'
...
def main():
    ...
    net = V33(backbone_path).cuda(device_ids[0]).train()
...
def train(net, optimizer):
    ...
    for epoch in range(args['last_epoch'] + 1, args['last_epoch'] + 1 + args['epoch_num']):
        ...
        for data in train_iterator:
            ...
            loss = 1 * loss_4 + 1 * loss_3 + 2 * loss_2 + 4 * loss_1
